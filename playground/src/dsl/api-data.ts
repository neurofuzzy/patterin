...
export const API_DATA: Record<string, TypeInfo> = {
    ...
    'ShapeContext': {
        ...
        methods: {
            ...
            'offset': { params: ['distance: number', 'count?: number', 'miterLimit?: number'], returns: 'ShapeContext | ShapesContext', doc: 'Inset/outset shape outline' },
            'expand': { params: ['distance: number', 'count?: number'], returns: 'ShapeContext | ShapesContext', doc: 'Expand/outset shape' },
    ...
    'ShapesContext': {
        ...
        methods: {
            ...
            'offset': { params: ['distance: number', 'count?: number', 'miterLimit?: number'], returns: 'ShapesContext', doc: 'Inset/outset (count=0: in-place, count>0: returns new with copies)' },
            'expand': { params: ['distance: number', 'count?: number'], returns: 'ShapesContext', doc: 'Expand/outset shapes (alias involved offset)' },
