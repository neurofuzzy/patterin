...
export const API_DATA: Record<string, TypeInfo> = {
    ...
    'ShapeContext': {
        ...
        methods: {
            ...
            'offset': { params: ['distance: number', 'miterLimit?: number'], returns: 'ShapeContext', doc: 'Inset/outset shape outline' },
    ...
    'ShapesContext': {
        ...
        methods: {
            ...
            'offset': { params: ['distance: number', 'miterLimit?: number'], returns: 'this', doc: 'Inset/outset all shape outlines' },
