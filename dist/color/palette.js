...
class Palette {
     ...
     * ```
     */
    constructor(count, ...zones) {
        this.modifiers = [];
        // Default HSL values
        this.defaultSaturation = 70;
        this.defaultLightness = 50;
     ...
     */
    yoyo() {
        return sequence.yoyo(...this.toArray());
    }
    /**
     ...
     */
    random(seed) {
        return sequence.random(seed, ...this.toArray());
    }
}
// Zone definitions mapping to hue ranges
Palette.ZONE_DEFINITIONS = {
