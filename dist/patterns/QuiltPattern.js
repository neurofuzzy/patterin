 ...
 */
export const brokenDishesTemplate = {
    name: 'brokenDishes',
    grid: 2,
    cells: [
        [{ type: 'hst', rotation: 0 }, { type: 'hst', rotation: 270 }],
 ...
 */
export const friendshipStarTemplate = {
    name: 'friendshipStar',
    grid: 3,
    cells: [
 ...
 */
export const dutchmansPuzzleTemplate = {
 ...
 */
export const sawtoothStarTemplate = {
    name: 'sawtoothStar',
    grid: 3,
    cells: [
...
export const quiltBlockTemplates = {
