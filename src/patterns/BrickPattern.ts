 ...
 * ```
 */
export function createBrick(options: BrickOptions): ShapesContext {
 ...
 */
function createRunningBond(options: BrickOptions): ShapesContext {
 ...
 */
function createStackBond(options: BrickOptions): ShapesContext {
    const { brickWidth, brickHeight, bounds } = options;
    const mortar = options.mortarWidth ?? 2;
    const shapes: Shape[] = [];
 ...
 */
function createBasketWeave(options: BrickOptions): ShapesContext {
    const { brickWidth, brickHeight, bounds } = options;
    const mortar = options.mortarWidth ?? 2;
    const shapes: Shape[] = [];
 ...
 */
function createFlemishBond(options: BrickOptions): ShapesContext {
    const { brickWidth, brickHeight, bounds } = options;
    const mortar = options.mortarWidth ?? 2;
    const shapes: Shape[] = [];
